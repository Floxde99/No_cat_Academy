...
function ajouterPromo(titre, description, nbEleves, id) {
  ...
  newLi.className = "list-group-item d-flex flex-column";
  newLi.id = `promo-${id}`;
  newLi.innerHTML = `
        ...
        <div class="d-flex justify-content-end mt-2">
            <button class="btn modif-btn btn-sm me-1" onclick="modifierPromo('${id}')" title="Modifier">
            ...
            <button class="btn delete-btn btn-sm" onclick="supprimerPromo('${id}')" title="Supprimer">
